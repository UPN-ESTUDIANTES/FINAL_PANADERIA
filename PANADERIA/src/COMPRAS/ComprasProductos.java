...
private String ID_EMPLEADO, Fecha_COM_PRO;
private int Cantidad_COM_PRO;
private double PrecioC_COM_PRO, Total_COM;

public ComprasProductos(String iD_COMPRA, String iD_PROVEEDOR, String iD_EMPLEADO, String fecha_COM_PRO,
		int cantidad_COM_PRO, double precioC_COM_PRO, double total_COM) {
	ID_COMPRA = iD_COMPRA;
